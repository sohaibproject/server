...
<div class="tab-pane" >
  ...
  <h3>add votre categorie</h3> 
</div>
   
 <form style="padding-top: 100px"  class="form-horizontal" method="POST" action="{{route('stor.categorie')}}"  enctype="multipart/form-data">
      @csrf
    <div class="form-group row">
      <label for="inputName"  class="col-sm-2 col-form-label">nom de categorie</label>
      <div class="col-sm-10">
      <input type="text" class="form-control" name="name" required id="inputName" placeholder="nom de categorie">
      </div>
